...
public class DrumKit implements MouseListener {
	...
	private void getGoing() throws MalformedURLException {
		...
		// 18. Add more images to make a drum kit. Remember to add this mouse listener
		// to each one.
		String snare = "eb81e8-tama_imperialstar_midnight_blue.jpg";
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (drumClicked.equals(snareLabelWithImage)) {
			playSound("drum.wav");
		}
	}
